...
- the complete 64-hex worker-source SHA-256 and exact snapshot directory;
...
Focused verification before the full gate: 122 WSL/ASR/model/dependency tests passed with zero
skips; 29 OmniASR asset tests passed with zero skips; Ruff, formatting and mypy were clean.
The complete local gate then passed 1,417/1,417 with zero skips. The exact remote run is recorded
only after this unit is committed.
