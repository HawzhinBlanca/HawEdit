...
The complete rebased project gate then reported `1,147 collected, 1,147 passed, 0 skipped` with
Ruff, format checking and mypy clean. `scripts/test-count.floor` ratcheted to 1,147.
