...
| `pyannote_adapter.py` | §3 Stage 0, §7 | Concrete Stage 0 `Diarizer` implementing pyannote Community-1 conversion, monotonic millisecond rounding, and refusal enforcement. |
